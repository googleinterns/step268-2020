  ...
  private MethodSpec generateLoadMethod() {
    ...
    MethodSpec.Builder method =
        MethodSpec.methodBuilder("load")
            ...
            .addStatement("noticeContainer.addNotice(new $T(FILENAME))", EmptyFileNotice.class)
            .addStatement(
    ...
    method
        .addStatement("$T.Builder builder = new $T.Builder()", gtfsEntityType, gtfsEntityType)
        .addStatement(
  ...
  private MethodSpec generateLoadMissingFileMethod() {
    ...
    MethodSpec.Builder method =
        MethodSpec.methodBuilder("loadMissingFile")
            ...
            .addStatement(
                "noticeContainer.addNotice(new $T(gtfsFilename()))", MissingRequiredFileError.class)
            .endControlFlow()
            .addStatement("validatorLoader.invokeSingleFileValidators(table, noticeContainer)")
            .addStatement("return table");
