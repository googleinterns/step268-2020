...
public class StopTimeIncreasingDistanceValidatorTest {
    private final GtfsStopTime stopTime1 =
            new GtfsStopTime.Builder()
                    ...
                    .build();
    private final GtfsStopTime stopTime2 =
            new GtfsStopTime.Builder()
                    .setCsvRowNumber(2)
                    .setTripId("trip1")
                    .setStopId("1002")
                    ...
                    .build();
    private final GtfsStopTime stopTime3 =
            new GtfsStopTime.Builder()
                    .setCsvRowNumber(3)
                    .setTripId("trip1")
                    .setStopId("1003")
                    ...
                    .build();
    private final GtfsStopTime stopTime4 =
            new GtfsStopTime.Builder()
                    .setCsvRowNumber(3)
                    .setTripId("trip1")
                    .setStopId("1003")
    ...
    public void stopTimeDecreasingDistanceShouldGenerateNotice() {
        ...
        assertThat(noticeContainer.getNotices())
                .containsExactly(
                        new DecreasingStopTimeDistanceNotice("trip1", 3, 3, 1.4, 2, 2, 1.5));
    }
    

    // TO DO: Decide what to do when it doesn't change, currently does not change 
    @Test
