...
public class TripHasNoDuplicateStopsValidatorTest {
  ...
  private final GtfsTrip trip2_route1 =
      new GtfsTrip.Builder().setCsvRowNumber(5).setTripId("trip2").setRouteId("route1").build();
  private final GtfsTrip trip3_route2 =
      new GtfsTrip.Builder().setCsvRowNumber(7).setTripId("trip3").setRouteId("route2").build();
  ...
  @Test
  public void tripWithDuplicateShouldGenerateNotice() {
    final NoticeContainer noticeContainer = new NoticeContainer();
    TripHasNoDuplicateStopsValidator validator = new TripHasNoDuplicateStopsValidator();
    ...
    assertThat(noticeContainer.getNotices())
        .contains(new TripWithDuplicateStopNotice(/* stopName = */ "stop1",
            /* prevStopId  = */ "1001", /* prevCsvRowNumber = */ 3, /* stopId  = */ "1002",
            /* csvRowNumber = */ 4, /* routeId = */ "route1", /* exampleTripId = */ "trip1"));
  }
  
  @Test
  public void tripWithRepeatedDuplicateShouldGenerateOneNotice() {
    final NoticeContainer noticeContainer = new NoticeContainer();
    TripHasNoDuplicateStopsValidator validator = new TripHasNoDuplicateStopsValidator();
    ...
    validator.validate(noticeContainer);
    assertThat(noticeContainer.getNotices())
        .containsExactly(new TripWithDuplicateStopNotice(/* stopName = */ "stop1",
            /* prevStopId  = */ "1001", /* prevCsvRowNumber = */ 3, /* stopId  = */ "1002",
            /* csvRowNumber = */ 4, /* routeId = */ "route1", /* exampleTripId = */ "trip1"));
  }

  @Test
  public void tripNoDuplicatesShouldNotGenerateNotice() {
    final NoticeContainer noticeContainer = new NoticeContainer();
    TripHasNoDuplicateStopsValidator validator = new TripHasNoDuplicateStopsValidator();
  ...
  public void shouldGenerateNoticeForEachRepeatedDuplicateOnEachRoute() {
    ...
    assertThat(noticeContainer.getNotices())
        .containsExactly(new TripWithDuplicateStopNotice(/* stopName = */ "stop1",
            /* prevStopId  = */ "1001", /* prevCsvRowNumber = */ 3, /* stopId  = */ "1002",
            /* csvRowNumber = */ 4, /* routeId = */ "route1", /* exampleTripId = */ "trip1"), new TripWithDuplicateStopNotice(/* stopName = */ "stop1",
            /* prevStopId  = */ "1001", /* prevCsvRowNumber = */ 3, /* stopId  = */ "1002",
            /* csvRowNumber = */ 4, /* routeId = */ "route2", /* exampleTripId = */ "trip3"));
