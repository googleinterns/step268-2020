 ...
 *
 * <p>* {@code int} - {@code INTEGER}; * {@code double} - {@code FLOAT}; * {@code String} - {@code
 * TEXT}; * {@code GtfsColor} - {@code COLOR}; * {@code GtfsDate} - {@code DATE}; * {@code GtfsTime}
 * - {@code TIME}; * {@code ZoneId} - {@code TIMEZONE}; * {@code Locale} - {@code LANGUAGE_CODE}; *
 * {@code Currency} - {@code CURRENCY_CODE} * {@code BigDecimal} - {@code DECIMAL}.
 *
 * <p>However, if you need {@code EMAIL} instead of {@code TEXT}, {@code LATITUDE} instead of {@code
