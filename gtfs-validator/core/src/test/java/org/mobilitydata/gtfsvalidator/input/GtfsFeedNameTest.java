...
public class GtfsFeedNameTest {
  ...
  public void getISOAlpha2CountryCode() {
    ...
    assertThat(GtfsFeedName.parseString("au-sydney-buses").getISOAlpha2CountryCode())
        .isEqualTo("AU");
  ...
  public void getCountryLastName() {
    ...
    assertThat(GtfsFeedName.parseString("au-sydney-buses").getCountryLastName())
        .isEqualTo("buses-sydney-au");
  ...
  public void parseString() {
    ...
    assertThat(GtfsFeedName.parseString("au-sydney-buses").getCountryFirstName())
        .isEqualTo("au-sydney-buses");
  ...
  public void equalsMethod() {
    assertThat(GtfsFeedName.parseString("nl-openov"))
        .isEqualTo(GtfsFeedName.parseString("nl-openov"));
    assertThat(GtfsFeedName.parseString("nl-openov"))
        .isEqualTo(GtfsFeedName.parseString("openov-nl"));
    assertThat(GtfsFeedName.parseString("uk-feed"))
        .isNotEqualTo(GtfsFeedName.parseString("gb-feed"));
  }
}
