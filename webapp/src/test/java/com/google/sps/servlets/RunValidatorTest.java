...
public class RunValidatorTest {
  ...
  public void testSimpleGtfsFeed() {
    NoticeContainer json = UploadServlet.runValidator("src/test/resources/SAMPLE.zip", "au-sydney-buses");
    // String expected =
  ...
  public void testBartGtfsFeed() {
    NoticeContainer json = UploadServlet.runValidator("src/test/resources/bart_gtfs.zip", "us-bay-area");
    // String expected =
